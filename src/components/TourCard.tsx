...
import { img, type Tour } from '../data/tours'
  ...
  return (
    ...
    >
      ...
      <div className="flex flex-1 flex-col p-5">
        <h3 className="font-display text-lg font-bold text-navy transition group-hover:text-teal">{tour.name}</h3>
        <p className="mt-2 flex-1 text-sm leading-relaxed text-body">{tour.summary}</p>
